          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="gsap-fade-up space-y-5 text-muted-foreground leading-relaxed">
                <p><strong className="text-foreground">Communication & Information Systems Limited (CIS Limited)</strong> is a Limited liability company registered under the Company and Allied Matters decree of the Federal Government of Nigeria to operate the business of Computer, Telecommunications and Information technology.</p>
                <p>We provide End-to-End Business Solutions, Computer and Information services as well as sales and servicing of computer and telecom equipment. Our commitment to quality and innovation has made us a trusted partner for organizations across all sectors in Nigeria.</p>
              </div>
              ...
              <Link to="/contact" className="gsap-fade-up mt-8 btn-pill-primary text-xs inline-flex shadow-lg shadow-primary/20">Get in Touch <ArrowRight className="w-4 h-4" /></Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section ref={valuesRef} className="section-padding bg-muted/30 relative overflow-hidden">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-7">
            {values.map(v => (
              <div key={v.title} className="gsap-stagger glass-card rounded-3xl p-8 hover-lift group relative overflow-hidden">
