...
import heroMeeting from "@/assets/hero_img.png";
...
const services = [
  {
    ...
    description:
      "Scalable cloud infrastructure and migration solutions for modern enterprises.",
    image: servicesCloud,
  },
  {
    icon: Server,
    ...
    description:
      "End-to-end network design, deployment, and management services.",
  ...
  },
  {
    ...
    description: "Server and desktop virtualization to optimize IT resources.",
    image: serviceDatacenter,
  },
  {
    icon: Headphones,
    title: "Consultancy",
    description: "Expert IT consultancy and strategic technology advisory.",
...
const whyUs = [
  {
    ...
    desc: "20+ years delivering enterprise IT solutions across Nigeria.",
    num: "20+",
  },
  {
    icon: Users,
    title: "Dedicated Team",
    desc: "Certified professionals across all technology domains.",
    num: "50+",
  },
  {
    icon: Zap,
    title: "Fast Delivery",
    desc: "Agile project management ensuring on-time deployments.",
    num: "99%",
  },
  {
    icon: Globe,
    title: "Wide Coverage",
    desc: "Serving organizations across all sectors nationwide.",
    num: "200+",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div>
              <div className="hero-badge inline-flex items-center gap-2 bg-primary-foreground/5 backdrop-blur-xl border border-primary-foreground/10 rounded-full px-5 py-2.5 mb-8">
                ...
                <span className="text-xs font-medium text-primary-foreground/70 tracking-wide">
                  Nigeria's Leading IT Solutions Provider
                </span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-[3.4rem] xl:text-[3.8rem] font-bold text-primary-foreground leading-[1.08] mb-7 font-display">
                ...
                <span className="hero-title-line block">
                  Telecom & <span className="gradient-text">Business</span>
                </span>
                <span className="hero-title-line block">
                  Technology <span className="text-secondary">Solutions</span>
                </span>
              </h1>
              <p className="hero-desc text-base md:text-lg text-primary-foreground/50 leading-relaxed mb-10 max-w-lg">
                CIS Limited provides complete computer, telecom, cloud, and
                enterprise technology solutions for organizations in Nigeria.
              </p>
              <div className="hero-buttons flex flex-wrap gap-4 items-center">
                <Link
                  to="/services"
                  className="btn-pill-primary shadow-xl shadow-primary/20"
                >
                ...
                <button className="flex items-center gap-3 ml-2 group">
                  ...
                  <span className="text-sm text-primary-foreground/50 group-hover:text-secondary transition-colors hidden sm:inline">
                    Watch Video
                  </span>
                </button>
              </div>
            ...
            >
              ...
              <div className="gsap-fade-up relative">
                <div
                  className="img-overlay rounded-3xl h-[400px] shadow-2xl overflow-hidden"
              ...
              <div className="hero-float hero-float-card absolute top-[5%] left-[5%] z-30 bg-card/95 backdrop-blur-xl rounded-2xl px-4 py-3 shadow-2xl border border-border/50">
                <div className="flex items-center gap-2">
                  ...
                  <Star className="w-4 h-4 text-cis-lime fill-cis-lime" />
                  <Star className="w-4 h-4 text-cis-lime fill-cis-lime" />
                  <span className="text-xs font-bold text-foreground font-display ml-1">
                    Since 1995
                  </span>
                </div>
              </div>
      ...
      >
        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <SectionHeading
                label="About CIS Limited"
                title="Empowering Your Success with Digital Expertise"
                center={false}
              />
              <p className="gsap-fade-up text-muted-foreground leading-relaxed mb-8">
                Communication & Information Systems Limited is a leading IT
                company delivering end-to-end business solutions, computer and
                information services, as well as sales and servicing of computer
                and telecom equipment across Nigeria.
              </p>
                ...
                {expertise.map((e) => (
                  <div key={e.label}>
                    ...
                    <div className="h-2.5 bg-muted rounded-full overflow-hidden">
                      <div
                        className="progress-fill h-full gradient-brand rounded-full"
                        style={{ width: `${e.pct}%` }}
                      />
                    </div>
                  </div>
              ...
              <Link
                to="/about"
                className="gsap-fade-up btn-pill-primary text-xs shadow-lg shadow-primary/20"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={stat.label} className="text-center group">
                ...
                <div
                  className="text-4xl md:text-5xl font-bold text-primary-foreground counter-num font-display"
                  data-target={stat.num}
                >
                  0+
                </div>
                <div className="text-sm text-primary-foreground/40 mt-2 font-medium">
                  {stat.label}
                </div>
              </div>
            ))}
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-14">
            <div>
              <SectionHeading
                label="Our Services"
                title="Boost Your Business with Our Expertise"
                center={false}
              />
            </div>
            <Link
              to="/services"
              className="btn-pill-outline text-xs mt-4 md:mt-0 self-start md:self-auto"
            >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((s, i) => (
              <div
                key={s.title}
                className={`gsap-stagger service-card-premium group ${i === 0 ? "sm:row-span-2" : ""}`}
              >
                <div className={`card-img relative ${i === 0 ? "!h-72" : ""}`}>
                  ...
                  <div className="absolute bottom-4 left-4 right-4 opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-500">
                    <Link
                      to="/services"
                      className="text-xs text-primary-foreground font-semibold flex items-center gap-2"
                    >
      ...
      >
        ...
        <div className="container mx-auto relative z-10 px-4">
          <SectionHeading
            ...
            description="Tailored technology solutions designed to transform your business operations."
            light
          />
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
            {solutions.map((sol, i) => (
              <div
                key={sol}
                className="gsap-fade-up glass-card-dark rounded-2xl p-6 text-center text-primary-foreground group cursor-default transition-all duration-500 hover:bg-primary-foreground/8 hover:-translate-y-2 hover:shadow-2xl hover:shadow-secondary/10"
      ...
      <section ref={parallaxRef} className="section-padding">
        <div className="container mx-auto">
          <SectionHeading
            ...
            title="Partnering with Global Leaders"
          />
          <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-5">
            {partners.map((p) => (
              <div
                key={p}
                className="gsap-parallax glass-card rounded-2xl h-28 flex items-center justify-center hover-lift group cursor-default"
                data-speed="0.1"
              >
                <span className="font-bold text-xl text-muted-foreground/20 group-hover:text-primary group-hover:scale-110 transition-all duration-500 font-display">
                  {p}
                </span>
              </div>
            ))}
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-7">
            {whyUs.map((item, i) => (
              <div
                key={item.title}
                className={`gsap-scale glass-card rounded-3xl p-8 text-center hover-lift group relative overflow-hidden ${i % 2 === 1 ? "lg:mt-8" : ""}`}
              >
                {/* Background number */}
                <span className="absolute top-4 right-4 text-5xl font-bold text-primary/5 font-display">
                  {item.num}
                </span>
                ...
                <h3 className="font-bold text-foreground mb-2 font-display relative z-10">
                  {item.title}
                </h3>
      ...
      <section className="relative py-28 md:py-36 overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10 px-4">
          ...
          <p className="text-primary-foreground/40 mb-10 max-w-xl mx-auto text-lg">
            Let's discuss how CIS Limited can help your organization achieve its
            technology goals.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link
              to="/contact"
              className="btn-pill-primary text-sm shadow-xl shadow-primary/20"
            >
